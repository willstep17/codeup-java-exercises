...
public class ServerNameGenerator {
    public static String[] adjectives = {"Superficial", "Separate", "Industrious", "Astonishing", "Eastern", "Cooing", "Terrific", "Unaccountable", "Optimal", "Jolly", "Funny", "Envious", "Habitual"};
